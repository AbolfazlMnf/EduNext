...
export default async function CoursePage({
  ...
  return (
    <StaggerWrapper
      className="min-h-screen dark:bg-none dark:bg-[#1e1e1e]
     bg-[radial-gradient(circle_at_top_left,_#ffffff_0%,_rgba(255,255,255,0)_60%),linear-gradient(180deg,_#FAF7FC_0%,_#F3EEF6_45%,_#ECE6F2_100%)]
      text-[#1F1D43] pb-10"
    >
      <Container>
